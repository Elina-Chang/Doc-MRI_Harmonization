...
def predict(pth_root_path=r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\modified_05_newidentityloss"
                          r"\output\Norm1_41GE_and_75Philips\checkpoints\100",
            prediction_store_path=r"G:\PhD\StyleTransferPredictions\modified_05_newidentityloss\predictions"):
    ...
    for GE_modal in GE_modals_list:
        ...
        store_path = os.path.join(prediction_store_path, GE_modal.split("\\")[5])
