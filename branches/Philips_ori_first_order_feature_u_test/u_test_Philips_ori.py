...
def seperate_Philips_ori_csv(Philips_ori_csv_path):
    """

    :return: two separate dataframe.
    """
    # read .csv
    df = pd.read_csv(Philips_ori_csv_path, index_col=None)
    row_num = df.shape[0]
...
def u_test(Philips_ori_csv_path):
    """

    :param Philips_ori_csv_path:
    :return:
    """

    df1, df2 = seperate_Philips_ori_csv(Philips_ori_csv_path)
...
if __name__ == "__main__":
    Philips_ori_csv_path = r".\Philips_ori_image_type_original.csv"
    u_test(Philips_ori_csv_path)
