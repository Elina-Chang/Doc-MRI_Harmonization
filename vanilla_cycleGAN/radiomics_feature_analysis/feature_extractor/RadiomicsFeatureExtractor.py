...
if __name__ == '__main__':
    ...
    extractor.Execute(root_folder=r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\vanilla_cycleGAN"
                                  r"\radiomics_feature_analysis\data_for_feature_extractor\PhilipsStyle_data",
                      key_name_list=["t2sag_cycleGAN.nii.gz"],
                      roi_key="cervix_roi.nii.gz",
                      store_path=r"G:\PhD\Radiomics\MyRadiomics\GE_PHILIPS_Classify_BaselinePipe\cervix_roi"
                                 r"\GE41+PHILIPS75\OriCSVs\GE_cycleGAN_image_type_original(18+73).csv",
