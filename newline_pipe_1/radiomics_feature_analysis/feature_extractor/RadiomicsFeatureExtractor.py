...
if __name__ == '__main__':
    ...
    extractor.Execute(root_folder=r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\newline_pipe_1"
                                  r"\radiomics_feature_analysis\data_for_feature_extractor\PhilipsStyle_data",
                      key_name_list=["t2_sag_forFeatureExtractor.nii"],
                      roi_key="womb_roi_forFeatureExtractor.nii",
                      store_path=r".\csv\PhilipsStyle_image_type_original.csv",
                      show_key_name_list=[])
