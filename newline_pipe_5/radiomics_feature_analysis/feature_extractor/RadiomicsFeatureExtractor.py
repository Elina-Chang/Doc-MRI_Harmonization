...
if __name__ == '__main__':
    extractor = RadiomicsFeatureExtractor("exampleMR_NoResampling.yaml")
    # extractor.Execute(root_folder=r"G:\PhD\Data_renji\Data_forFeatureExtractor\GE_3T",
    #                   key_name_list=["t2sag_proposed.nii.gz"],
    #                   roi_key="cervix_roi.nii.gz",
    #                   store_path=r"G:\PhD\Radiomics\MyRadiomics\GE_PHILIPS_Classify_BaselinePipe\cervix_roi"
    #                              r"\GE41+PHILIPS75\OriCSVs\GE_proposed_image_type_original(18+73).csv",
    #                   show_key_name_list=["t2"])

    extractor.Execute(root_folder=r"G:\PhD\Data_renji\Data_forFeatureExtractor_\GE_3T",
                      key_name_list=["t2sag_modified_05_newidentityloss.nii.gz"],
                      roi_key="cervix_roi.nii.gz",
                      store_path=r"G:\PhD\Radiomics\MyRadiomics\GE_PHILIPS_Classify_BaselinePipe\cervix_roi"
                                 r"\GE41+PHILIPS75\OriCSVs_\GE_modified_05_newidentityloss_image_type_original(18+73).csv",
                      show_key_name_list=["t2"])
