...
def predict(pth_root_path=r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\baseline_pipe\output"
                          r"\output02_Norm1_41GE_and_75Philips"):
    ...
    for GE_modal in GE_modals_list:
        ...
        store_path = os.path.join(r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\baseline_pipe"
                                  r"\model_prediction\predict_on_output02\predictions_on_GE_t2sag",
                                  GE_modal.split("\\")[4])
