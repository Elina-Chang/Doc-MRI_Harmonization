...
if __name__ == '__main__':
    ...
    extractor.Execute(root_folder=r"E:\PhD\Data_renji\Data_forFeatureExtractor\41GE",
                      key_name_list=["t2sag_newmatched.nii.gz"],
                      roi_key="cervix_roi.nii.gz",
                      store_path=r"E:\PhD\Radiomics\MyRadiomics\GE_PHILIPS_Classify_BaselinePipe\cervix_roi"
                                 r"\GE41+PHILIPS75\OriCSVs"
                                 r"\GE_newmatched_image_type_original(18+73).csv",
