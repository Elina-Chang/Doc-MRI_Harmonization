...
from newline_pipe_2.models import Generator
...
def predict(pth_root_path=r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\newline_pipe_2"
                          r"\output\Norm1_41GE_and_75Philips\200"):
    ...
    for GE_modal in GE_modals_list:
        ...
        store_path = os.path.join(r"G:\PhD\PycharmProjects\my_project\MRI_Harmonization\newline_pipe_2"
                                  r"\model_prediction\predictions",
                                  GE_modal.split("\\")[5])
